...
export default function Radar() {
  ...
  return (
    <>
      <PageHead no="09" kicker="Compare"
        title="Two players, <em>every</em> silo"
        sub="Two players — or two clubs — across all eight silos on one radar. Percentiled within position, 0–100." />
      <div className="card">
