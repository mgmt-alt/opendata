...
export default function Leaderboard() {
  ...
  return (
    <>
      <PageHead no="02" kicker="The rating"
        title="The <em>statted</em> score"
        sub="One 0–100 rating per player across eight silos — re-weight by role or by archetype. Five silos are full-season; three (marked *) come from the 10-match sample." />
      <FilterBar />
      <div className="card">
