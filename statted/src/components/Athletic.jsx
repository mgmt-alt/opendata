...
export default function Athletic() {
  ...
  return (
    <>
      <PageHead no="04" kicker="Athletic"
        title="Fast, <em>and</em> relentless"
        sub="Peak sprint speed (PSV99) against work rate (metres per minute). The top-right corner is where the fast meet the tireless." />
      <FilterBar />
      <div className="card">
