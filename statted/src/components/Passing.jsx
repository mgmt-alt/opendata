...
export default function Passing() {
  ...
  return (
    <>
      <h1>Passers: volume, security &amp; risk</h1>
      <p className="sub">Pass volume against completion rate. Blue = completes more than expected given difficulty (xPass); red = fewer.</p>
      <FilterBar />
      <div className="card">
