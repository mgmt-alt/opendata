...
export default function Explorer() {
  ...
  return (
    <>
      ...
      <p className="sub">One dot per player. Pick a silo tab to narrow the axis menus; your picks persist across tabs, so you can cross silos.</p>
      <FilterBar />
      <div className="card">
