...
export default function Profile() {
  ...
  return (
    <>
      <PageHead no="08" kicker="Player card"
        title="Eight <em>faces</em>, one player"
        sub="A silo face for each strength and a per-metric drill-down against positional peers. Search any player or club." />
      <div className="card">
