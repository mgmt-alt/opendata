...
METRIC_REGISTRY = [
    ...
    _R("clearances", "Clearances (total)", "Defending", "sample", 1, True, "int"),
    _R("danger_prevented", "Danger prevented (stops+reduces)", "Defending", "sample", 1, True, "int"),
    _R("regains", "Ball regains (total)", "Defending", "sample", 1, True, "int"),
    _R("pressures", "Pressures (total)", "Defending", "sample", 1, False, "int"),
    _R("disruptions", "Disruptions (total)", "Defending", "sample", 1, False, "int"),
